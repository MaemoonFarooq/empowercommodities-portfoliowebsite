              ...
              >
                <div className="border-b border-gray-600">
                  ...
                  <button
                    ...
                    className="w-full py-6 flex items-center justify-between hover:bg-gray-800/20 transition-colors duration-300 group focus:outline-none focus:bg-gray-800/20"
                  >
                    <p className="text-white text-base lg:text-lg font-medium group-hover:text-gray-200 transition-colors duration-300 text-left pr-4">
                      {faq.question}
                    </p>
                    <ChevronDown
