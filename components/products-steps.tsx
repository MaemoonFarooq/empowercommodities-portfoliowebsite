...
const internationalCommodities: CommodityItem[] = [
  ...
  },
  {
    ...
    internationalImage: "/international.jpg",
    agrifuturesImage: "",
    description: "Global futures contracts across multiple asset classes and markets.",
  ...
  },
  {
    ...
    position: { top: "66%", left: "66.66%" },
    mobilePosition: { top: "120%", left: "25%" },
  },
]
